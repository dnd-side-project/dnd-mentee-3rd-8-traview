...
export default ({userId,num, interest, like, user, username, imagePath, location}) => {
    if (num === 0) {
        return (
            <Container >
                <BestImage src={imagePath} alt={user}/>
                <InterBox><img src="/images/Interesting.png" alt="Interesting"/></InterBox>
                <InterestCount>{interest}</InterestCount>
                <LikeBox><img src="/images/Like.png" alt="Like"/></LikeBox>
                <LikeNumber>{like}</LikeNumber>
                <Username>{username}</Username>
                <AvatarBox><Avatar src={user} alt="Avatar"/></AvatarBox>
                <LocalBox><img src="/images/location.png" alt="Location"/></LocalBox>
        ...
        return (
            <Container >
                ...
                <Username>{username}</Username>
                <AvatarBox><Avatar src={user} alt="Avatar"/></AvatarBox>
                <LocalBox><img src="/images/location.png" alt="Like"/></LocalBox>
                <LocationName>{location}</LocationName>
            </Container>
